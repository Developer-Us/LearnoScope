    ...
    <div>
      ...
      <div className="container card shadow-lg p-3 mb-5 bg-body rounded" style={{ width: "350px", display: "flex" }} >
        ...
        <form action="" className='container'>
          <div className="mb-3">
            <input type="text" className="form-control" id="exampleFormControlInput1" placeholder="Room Name" />
          </div>
          <div className="mb-3">
            <input type="password" className="form-control" id="exampleFormControlInput1" placeholder="Room Pass" />
          </div>
          <div className="mb-3">
            <input type="password" className="form-control" id="exampleFormControlInput1" placeholder="Confirm Room Pass" />
          </div>
          <center>
