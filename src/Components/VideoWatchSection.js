                    ...
                    <div className='VideoMetaData'>
                        ...
                        <div className="LikeShareWatchLaterReportBtns">
                            <span style={{ display: "flex", flexDirection: "column" }}>
                                {/* likebutton */}
                                <svg xmlns="http://www.w3.org/2000/svg" className="VideoMetaBtn" style={{ height: "35px", width: "35px", margin: "5px 10px" }} onMouseEnter={DisplayLikeText} onMouseLeave={HideLikeText} fill="currentColor" class="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16" >
                            ...
                            <span style={{ display: "flex", flexDirection: "column" }}>
                                {/* sharebutton  */}
                                <svg xmlns="http://www.w3.org/2000/svg" onMouseEnter={DisplayShareText} onMouseLeave={HideShareText} className="VideoMetaBtn" style={{ height: "35px", width: "35px", margin: "5px 10px" }} fill="currentColor" class="bi bi-send-fill" viewBox="0 0 16 16">
                                    <path d="M15.964.686a.5.5 0 0 0-.65-.65L.767 5.855H.766l-.452.18a.5.5 0 0 0-.082.887l.41.26.001.002 4.995 3.178 3.178 4.995.002.002.26.41a.5.5 0 0 0 .886-.083l6-15Zm-1.833 1.89L6.637 10.07l-.215-.338a.5.5 0 0 0-.154-.154l-.338-.215 7.494-7.494 1.178-.471-.47 1.178Z" />
                                </svg>
                                <p id="shareBtnText">Share</p></span>
                            <span style={{ display: "flex", flexDirection: "column" }}>
                                <svg xmlns="http://www.w3.org/2000/svg" onMouseEnter={DisplayWatchLaterText} onMouseLeave={HideWatchLaterText} className="VideoMetaBtn" style={{ height: "35px", width: "35px", margin: "5px 10px" }} fill="currentColor" class="bi bi-watch" viewBox="0 0 16 16">
                            ...
                            <span style={{ display: "flex", flexDirection: "column" }}>
                                {/* reportbutton */}
                                <svg xmlns="http://www.w3.org/2000/svg" onMouseEnter={DisplayReportText} onMouseLeave={HideReportText} className="VideoMetaBtn" style={{ height: "35px", width: "35px", margin: "5px 10px" }} fill="currentColor" class="bi bi-shield-fill-exclamation" viewBox="0 0 16 16">
