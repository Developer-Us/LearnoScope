...
export default function VideoFeed(props) {
    ...
    return (
        <div>
            ...
            <div id="wishUser" style={{ display: "none", width: "70%" }} className="container mx-auto shadow p-3 mb-5 bg-body rounded fs-2"><span id="wishUser-time"></span> <strong id="wishUser-username"></strong> :)</div>
