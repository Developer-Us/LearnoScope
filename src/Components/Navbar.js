...
export default function Navbar() {
    ...
    return (
        <div>
            <nav id="Navbar" className="my-2 mx-2 navbar-light navbar-custom align-items-center" >
                   ...
                   <div className="d-flex">
                    ...
                    <div className="my-auto" id="">
                        <form className="d-flex " id='Nav_SearchBar'>
                            {/* Search Bar */}
                            <button id="Backbtn" className="btn btn-outline-dark p-2 mx-2" type="button" onClick={GoBack}>
                            ...
                            <button id="SearchIcon" className="btn btn-outline-dark p-2" type="button" onClick={SearchHandle}>
